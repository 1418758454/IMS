 ...
 */
@Mapper
public interface GraduateTheoryCourseMapper extends BaseMapper<GraduateTheoryCourse> {

    // 查询数据库中所有id为userId的记录，将其用户名改为userName
    @Update("update teaching_graduate_theory_course set user_name = #{userName} where user_id = #{userId}")
